...
//
// `label` and `onActivate` are accepted as props (not hardcoded) specifically
// so Phase 2 (per the Homepage Evolution Roadmap) can layer in scroll-aware
...
export function MobileActionBar({ label = "Book a Demo" }) {
  ...
  return (
    ...
    >
      <Button
        type="button"
        onClick={() => openLeadForm("mobile-action-bar")}
